...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <form action = "/bulk" enctype="multipart/form-data" method="post">
            <div class="form-group">
                <br/>
                <b>Bulk data load </b><br/><br/>
                <input name="foo" type="file"/>
                <input type="submit" class="btn btn-primary" value="Bulk load">
            </div>
            </form>
        </div>
        <hr/>
        <div class="form-group">
            <h4>Deletion</h4><hr/>
            <form action="/deleteSingle" method="post">
            <div class="form-group">
